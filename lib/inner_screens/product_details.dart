...
final _quantityTextController = TextEditingController(text: '1');
  ...
  @override
  void dispose() {
    // Clean up the the controller when the widget is disposed
                      ...
                      child: Row(
                        ...
                        children: [
                          TextWidget(
                              ...
                              color: Colors.green,
                              textSize: 22, isTitle: true
                          ),
                          TextWidget(text: getCurrProduct.isPiece ? 'Piece' : '/Kg',
                              color: color,
                              textSize: 12,
                              isTitle: false
                          ),
                                  ...
                                  child: Row(
                                    children: [
                                      TextWidget(
                                        ...
                                        color: color,
                                        textSize: 20, isTitle: true,
                                      ),
                                      TextWidget(
                                        text: '${_quantityTextController.text}Kg',
                                        color: color,
                                        textSize: 16, isTitle: false,
                                      ),
